...
SQL Server CPU utilization is represented by the BLUE line
The Red line represents all other processes besides of SQL Server that impacting your performance.
*/
