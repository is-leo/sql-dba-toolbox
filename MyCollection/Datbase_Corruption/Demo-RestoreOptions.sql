...
TO DISK = N'C:\Pluralsight\Company_Full.bak'
WITH INIT;
GO
...
BACKUP LOG [Company]
TO DISK = N'C:\Pluralsight\Company_Log1.bak'
WITH INIT;
GO
...
BACKUP LOG [Company]
TO DISK = N'C:\Pluralsight\Company_Log2.bak'
WITH INIT;
GO
...
FROM DISK = N'C:\Pluralsight\Company_Full.bak'
WITH REPLACE;
GO

-- And the log backups
RESTORE LOG [Company]
FROM DISK = N'C:\Pluralsight\Company_Log1.bak';

RESTORE LOG [Company]
FROM DISK = N'C:\Pluralsight\Company_Log2.bak';
GO
...
RESTORE DATABASE [Company]
FROM DISK = N'C:\Pluralsight\Company_Full.bak'
WITH REPLACE, STANDBY = N'C:\Pluralsight\standbyfile.dat';
GO
...
RESTORE LOG [Company]
FROM DISK = N'C:\Pluralsight\Company_Log1.bak'
WITH STANDBY = N'C:\Pluralsight\standbyfile.dat';
GO
...
RESTORE DATABASE [Company]
FROM DISK = N'C:\Pluralsight\Company_Full.bak'
WITH REPLACE, NORECOVERY, STOPAT = '2023-10-05 17:36:06.477';
GO

RESTORE  LOG [Company]
FROM DISK = N'C:\Pluralsight\Company_Log1.bak'
WITH STANDBY = N'C:\Pluralsight\standbyfile.dat',
STOPAT = '2023-10-05 17:36:06.477';
GO
