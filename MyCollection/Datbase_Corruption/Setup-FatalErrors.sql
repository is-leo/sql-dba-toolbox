...
CREATE DATABASE [FatalCorruption1] ON PRIMARY (
    ...
    FILENAME = N'C:\Pluralsight\FatalCorruption1.mdf')
LOG ON (
    NAME = N'FatalCorruption1_log',
    FILENAME = N'C:\Pluralsight\FatalCorruption1_log.ldf');

CREATE DATABASE [FatalCorruption2] ON PRIMARY (
    NAME = N'FatalCorruption2',
    FILENAME = N'C:\Pluralsight\FatalCorruption2.mdf')
LOG ON (
    NAME = N'FatalCorruption2_log',
    FILENAME = N'C:\Pluralsight\FatalCorruption2_log.ldf');

CREATE DATABASE [FatalCorruption3] ON PRIMARY (
    NAME = N'FatalCorruption3',
    FILENAME = N'C:\Pluralsight\FatalCorruption3.mdf')
LOG ON (
    NAME = N'FatalCorruption3_log',
    FILENAME = N'C:\Pluralsight\FatalCorruption3_log.ldf');
GO
