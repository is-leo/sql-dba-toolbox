...
CREATE DATABASE [Company] ON PRIMARY (
    NAME = N'Company',
    FILENAME = N'C:\Pluralsight\Company.mdf')
LOG ON (
    NAME = N'Company_log',
    FILENAME = N'C:\Pluralsight\Company_log.ldf');
GO
...
TO DISK = N'C:\Pluralsight\Company_Full_Sunday.bak'
WITH INIT;
GO

-- And start a file for Monday's log backups
BACKUP LOG [Company]
TO DISK = N'C:\Pluralsight\Company_Log_Monday.bak'
WITH INIT;
GO
...
BEGIN
	...
	BEGIN
		BACKUP DATABASE [Company]
		TO DISK = N'C:\Pluralsight\Company_Diff_Monday.bak'
		WITH DIFFERENTIAL;
	END
...
BACKUP LOG [Company]
TO DISK = N'C:\Pluralsight\Company_Log_Tuesday.bak'
WITH INIT;
GO
...
BACKUP LOG [Company]
TO DISK = N'C:\Pluralsight\Company_Log_Tail.bak'
...
RESTORE HEADERONLY
FROM DISK =	N'C:\Pluralsight\Company_Full_Sunday.bak'

RESTORE HEADERONLY
FROM DISK =	N'C:\Pluralsight\Company_Diff_Monday.bak'

RESTORE HEADERONLY
FROM DISK =	N'C:\Pluralsight\Company_Log_Monday.bak';
GO

RESTORE HEADERONLY
FROM DISK =	N'C:\Pluralsight\Company_Log_Tuesday.bak';
GO
...
RESTORE DATABASE [Company]
FROM DISK = N'C:\Pluralsight\Company_Log_Tail.bak'
WITH NORECOVERY;
GO
