...
Find all matching column names between tables. 
Useful for exploring databases with implied relationships but no foreign keys.
...
USE your_db -- change to the desired db
GO
