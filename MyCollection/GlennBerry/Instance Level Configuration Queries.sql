...
-- optimize for ad hoc workloads (should be 1), beneficial in environments with a significant
--number of infrequently executed ad-hoc queries & not in environments dominated by frequently executed queries
...
-- Memory dumps are generated when SQL Server has a serious error
