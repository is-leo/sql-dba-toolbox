/*============================================================================
  ...
  Date:     November 2023
  Version:  Works on versions 2008-2022 (requires: sp_SQLskills_ExposeColsInIndexLevels)
  UPDATES:  Added new output for 2022 without memory_optimized / groups
...
IF OBJECTPROPERTY(OBJECT_ID('sp_SQLskills_SQL2008_helpindex'), 'IsProcedure') = 1
	DROP PROCEDURE [sp_SQLskills_SQL2008_helpindex];
GO
...
AS
-- November 2023: Removed memory_optimized for 2022
...
-- Query by version
    IF CONVERT(smallint, SUBSTRING(CONVERT(varchar(50), SERVERPROPERTY('ProductVersion')), 1, 2)) < 14
	...
	IF CONVERT(smallint, SUBSTRING(CONVERT(varchar(50), SERVERPROPERTY('ProductVersion')), 1, 2)) IN (14, 15)        
        select @ExecStr = 
    ...
    IF CONVERT(smallint, SUBSTRING(CONVERT(varchar(50), SERVERPROPERTY('ProductVersion')), 1, 2)) > 15
