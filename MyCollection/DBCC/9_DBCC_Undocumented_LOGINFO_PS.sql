/*
	Verify the recovery model for AdventureWorks2019
*/ 
USE [master];
GO
...
USE [master];
GO
ALTER DATABASE [AdventureWorks2019] MODIFY FILE ( NAME = N'AdventureWorks2019_Log', FILEGROWTH = 10%);
GO
...
*/
DECLARE @BackupPath NVARCHAR(100);
SET @BackupPath = 'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\Backup\AW2019_TLog_' + 
	REPLACE(CONVERT(nvarchar(19),SYSDATETIME(), 126), ':','') + '.bak';
