...
*/
EXEC sp_sqlskills_helpindex N'HumanResources.Employee';
GO
...
/*
	Using DBCC IND
*/
DBCC IND ('AdventureWorks2019', 'HumanResources.Employee', 1);
GO
...
INSERT INTO [dbo].[sp_tablepages]
	EXEC ('DBCC IND (AdventureWorks2019, [HumanResources.Employee], 1)');
GO
...
FROM [sys].[dm_db_database_page_allocations] 
	(DB_ID(N'AdventureWorks2019'),OBJECT_ID(N'HumanResources.Employee'),1,NULL,'DETAILED');
GO
...
DBCC TRACEON (3604);
GO
DBCC PAGE('AdventureWorks2019', 1, 1427, 2);
GO
...
DBCC TRACEON (3604);
GO
DBCC PAGE('AdventureWorks2019', 1, 1427, 3);
GO
...
DBCC TRACEON (3604);
GO
DBCC DBINFO(AdventureWorks2019) 
	WITH TABLERESULTS;
GO
...
*/
DBCC PAGE('AdventureWorks2019', 1, 9, 3)
	WITH TABLERESULTS;
GO
