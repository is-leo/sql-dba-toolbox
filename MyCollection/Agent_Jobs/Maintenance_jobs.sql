...
BEGIN
  ...
  SELECT 'DBA - DatabaseBackup - SYSTEM_DATABASES - FULL',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA - DatabaseBackup - USER_DATABASES - DIFF',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA - DatabaseBackup - USER_DATABASES - FULL',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA - DatabaseBackup - USER_DATABASES - LOG',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA - IndexOptimize - USER_DATABASES',
         'EXECUTE [dbo].[IndexOptimize]' + CHAR(13) + CHAR(10) + '@Databases = ''USER_DATABASES'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + ''',' + CHAR(13) + CHAR(10) + '@UpdateStatistics = ''ALL'',' + CHAR(13) + CHAR(10) + '@OnlyModifiedStatistics = ''Y''',
         @DatabaseName,
         'IndexOptimize'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA - sp_delete_backuphistory',
         ...
         'msdb',
         'DBA - sp_delete_backuphistory'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA - sp_purge_jobhistory',
         ...
         'msdb',
         'DBA - sp_purge_jobhistory'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA - CommandLog Cleanup',
  ...
  SELECT 'DBA - Output File Cleanup',
  ...
  BEGIN
   UPDATE @Jobs
   SET Selected = 1
   WHERE [Name] IN('DBA - DatabaseIntegrityCheck - USER_DATABASES','DBA - IndexOptimize - USER_DATABASES','DBA - CommandLog Cleanup')
  END
  ELSE IF SERVERPROPERTY('EngineEdition') = 8
  BEGIN
   UPDATE @Jobs
   SET Selected = 1
   WHERE [Name] IN('DBA - DatabaseIntegrityCheck - SYSTEM_DATABASES','DBA - DatabaseIntegrityCheck - USER_DATABASES','DBA - IndexOptimize - USER_DATABASES','DBA - CommandLog Cleanup','DBA - sp_delete_backuphistory','DBA - sp_purge_jobhistory')
  END
...
USE [msdb]
GO
EXEC msdb.dbo.sp_update_job @job_name=N'DBA - DatabaseBackup - USER_DATABASES - DIFF', 
		@enabled=0
GO
