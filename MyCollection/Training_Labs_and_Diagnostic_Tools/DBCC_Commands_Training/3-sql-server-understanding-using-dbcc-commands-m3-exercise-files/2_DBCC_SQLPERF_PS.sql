...
USE [master];
GO
ALTER DATABASE [AdventureWorks2019] MODIFY FILE 
( NAME = N'AdventureWorks2019_Log', FILEGROWTH = 1024KB );
GO
...
*/
CREATE TABLE [AdventureWorks2019].[dbo].[Track_LogSpace] (
...
INSERT INTO [AdventureWorks2019].[dbo].[Track_LogSpace] 
