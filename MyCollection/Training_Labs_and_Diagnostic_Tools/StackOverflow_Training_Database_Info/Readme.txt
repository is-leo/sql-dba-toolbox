# Stack Overflow SQL Server Database - 2018 September

For more information and the latest release:
http://www.brentozar.com/go/querystack

Imported from the Stack Exchange Data Dump published 2018-09-05
...
attach it to any SQL Server 2008 or newer instance. It does not use any
Enterprise Edition features like partitioning or compression, so it can be
attached to almost any edition (Developer/Standard/Enterprise). It's too big
to be attached to Express Edition.
