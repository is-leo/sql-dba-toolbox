-- Setup script for Corruption Examples demo
...
ALTER DATABASE [Company] SET SINGLE_USER;
GO
DBCC WRITEPAGE (N'Company', 1, 150, 0, 2, 0x0000, 1);
GO
...
CREATE DATABASE [Company2] ON PRIMARY (
    NAME = N'Company2',
    FILENAME = N'C:\Pluralsight\Company2.mdf')
LOG ON (
    NAME = N'Company2_log',
    FILENAME = N'C:\Pluralsight\Company2_log.ldf');
GO
...
ALTER DATABASE [Company2] SET SINGLE_USER;
GO
DBCC WRITEPAGE (N'Company2', 1, 448, 0, 2, 0x0000, 1);
GO
...
CREATE DATABASE [Company3] ON PRIMARY (
    NAME = N'Company3',
    FILENAME = N'C:\Pluralsight\Company3.mdf')
LOG ON (
    NAME = N'Company3_log',
    FILENAME = N'C:\Pluralsight\Company3_log.ldf');
GO
...
ALTER DATABASE [Company3] SET SINGLE_USER;
GO
DBCC WRITEPAGE (N'Company3', 1, 283, 0, 2, 0x0000, 1);
GO
