# SQL Server Service Configuration Standards
...
Do not treat these as incident triage scripts. For active performance incidents, start in `MyCollection/00-curated` and use this folder only when configuration evidence points here.